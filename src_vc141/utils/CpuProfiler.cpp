#define __CPU_PROFILER_SMP__
#define __CPU_PROFILER_CONSOLIDATE_THREADS__
...
#if !defined(__CPU_PROFILER_SMP__)
#undef threadlocal
#define threadlocal
#endif 
...
#if defined(__CPU_CPU_PROFILER_ENABLED__)
...
#if defined(__CPU_PROFILER_CONSOLIDATE_THREADS__)
