...
static int
safe_patch_from_module(base::win::IATPatchFunction* patch, HMODULE module, const char* function_name, void* new_function) {
  __try {
...
base::win::IATPatchFunction* IATPatch(HMODULE module, const char* function_name,
  ...
  if (0 != safe_patch_from_module(patch, module, function_name, new_function))
    return NULL;
